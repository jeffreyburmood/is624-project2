...
```{r,warning=FALSE}
# First, we'll train a set of linear models and generate a summary of their performance

# Next, we'll train a set of non-linear models and generate a summary of their performance

# Lastly, we'll train a set of tree-based modelas and generate a summary of their performance
