...
# Here's a comparison plot of the RMSE values
rmse.acc <- vector()
rmse.acc <- c(rmse.acc, acc.lm)
rmse.acc <- c(rmse.acc, acc.glm)
rmse.acc <- c(rmse.acc, acc.glmnet)
rmse.acc <- c(rmse.acc, acc.svm)
rmse.acc <- c(rmse.acc, acc.cart)
rmse.acc <- c(rmse.acc, acc.knn)
rmse.acc <- c(rmse.acc, acc.gbm)
rmse.acc <- c(rmse.acc, acc.cubist)
